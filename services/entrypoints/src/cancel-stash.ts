...
import { cancelStash } from "../../handlers/stashes/src/cancel-stash.js";
import { TABLE_NAME, documentClient } from "./clients.js";

/**
 * Lambda entry point for `POST /stashes/{id}/cancel`.
 *
 ...
 * `handlers/stashes/src/cancel-stash.ts`, where it is tested without AWS.
 *
...
export const handler = cancelStash({ repo });
