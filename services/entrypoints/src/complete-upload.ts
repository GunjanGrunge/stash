...
import { completeUpload } from "../../handlers/uploads/src/complete-upload.js";
import { TABLE_NAME, bucketName, documentClient, s3Client } from "./clients.js";

/**
 * Lambda entry point for `POST /uploads/{file_id}/complete`.
 *
...
export const handler = completeUpload({ repo, store });
