...
import { createStash } from "../../handlers/stashes/src/create-stash.js";
import { TABLE_NAME, documentClient } from "./clients.js";

/**
 * Lambda entry point for `POST /stashes`.
 *
 ...
 * `handlers/stashes/src/create-stash.ts`, where it is tested without AWS.
 *
...
export const handler = createStash({ repo });
